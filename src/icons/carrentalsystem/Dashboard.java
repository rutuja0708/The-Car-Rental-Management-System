...
public class Dashboard extends JFrame{
	...
	NewLabel.setBounds(0, 0, 1950, 1000); 
        ...
        JLabel AirlineManagementSystem = new JLabel("THE VIHAN GROUP WELCOMES YOU");
	...
	setJMenuBar(menuBar);
        ...
        JMenu AirlineSystem = new JMenu("CAR MANAGEMENT");
	...
	AirlineSystemHello.add(FlightDetailshello1);
        ...
        JMenuItem FlightDetailshello2 = new JMenuItem("ADD CARS");
