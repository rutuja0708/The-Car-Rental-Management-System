...
public class Reception extends JFrame {
	...
	public Reception(){
                ...
                setBounds(460, 200, 850, 570);
		contentPane = new JPanel();
		setContentPane(contentPane);
		contentPane.setLayout(null);
                ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/forth.jpg"));
		...
		btnNewButton.setBounds(10, 90, 200, 30);
		...
		btnNewButton_3.setBounds(10, 140, 200, 30);
		...
		btnNewButton_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					// TODO Auto-generated ca5ch block
					e1.printStackTrace();
				}
			}
		});
		btnNewButton_4.setBounds(10, 240, 200, 30);
		...
		JButton btnNewButton_6 = new JButton("Update Car Status");
		...
		JButton btnSearchRoom = new JButton("Search Car");
