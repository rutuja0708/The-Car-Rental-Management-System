...
public class UpdateCheck extends JFrame {
	...
	public UpdateCheck() throws SQLException {
		...
		setBounds(450, 200, 950, 500);
		contentPane = new JPanel();
		contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
		setContentPane(contentPane);
		contentPane.setLayout(null);
		
		JLabel lblUpdateCheckStatus = new JLabel(" Hand-On Details");
		...
		JLabel lblNewLabel_3 = new JLabel(" Hand-on date and time :");
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) { 
				...
				String s2 = txt_ID.getText(); //room_number;    
                                ...
                                c.s.executeUpdate("update customer set car = '"+s2+"', name = '"+s3+"', handover = '"+s4+"', deposit = '"+s5+"' where number = '"+s1+"'");
