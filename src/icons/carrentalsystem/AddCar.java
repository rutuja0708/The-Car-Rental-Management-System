...
public class AddCar extends JFrame implements ActionListener{
	...
	contentPane.setLayout(null);
        ...
        JLabel l10 = new JLabel("Add Cars");
        l10.setFont(new Font("Tahoma", Font.BOLD, 18));
	l10.setBounds(194, 10, 120, 22);
	contentPane.add(l10);
        
	JLabel l0 = new JLabel("Car Name");
	l0.setForeground(new Color(25, 25, 112));
	l0.setFont(new Font("Tahoma", Font.BOLD, 14));
	l0.setBounds(64, 40, 102, 22);
	contentPane.add(l0);
        
          t1 = new JTextField();
          
	t1.setBounds(174, 40, 156, 20);
	contentPane.add(t1);
        
	JLabel l1 = new JLabel("Car Number");
	...
	contentPane.add(l5);
        ...
        comboBox_3 = new JComboBox(new String[] { "Five Sitter", "Seven sitter"});
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                ...
                String str = "INSERT INTO car values( '"+name+"', '"+carnumber+"', '"+available+"', '"+status+"','"+price+"', '"+type+"')";
