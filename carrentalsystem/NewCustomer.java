...
public class NewCustomer extends JFrame {
	...
	public NewCustomer() throws SQLException {
		...
		JLabel lblReserveRoomNumber = new JLabel("Allocated Car Number :");
		...
		contentPane.add(lblReserveRoomNumber);
                ...
                try{
                    ...
                    while(rs.next()){
                        c1.add(rs.getString("carnumber"));    
                    }
                }catch(Exception e){ }
                c1.setBounds(271, 274, 150, 20);
		contentPane.add(c1);
		
		JLabel lblCheckInStatus = new JLabel("Hand-on date & Time:");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s7 =  t5.getText();
                                ...
                                String q2 = "update car set availability = 'Available' where  carnumber = '"+s6+"'";
