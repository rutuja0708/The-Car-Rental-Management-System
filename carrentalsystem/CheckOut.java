...
public class CheckOut extends JFrame{
	...
	public void close(){
		...
		contentPane.add(c1);
                ...
                ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/tick.jpg"));
                    ...
                    public void actionPerformed(ActionEvent ae){
                        ...
                        try{
                            ...
                            if(rs.next()){
                                ...
                                t1.setText(rs.getString("carnumber"));    
                            }
                        }catch(Exception e){ }
                    }
                });
		...
		JLabel lblRoomNumber = new JLabel("Car Number:");
		...
		btnCheckOut.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String deleteSQL = "Delete from customer where number = '"+id+"'";
                                String q2 = "update car set availability = 'Available' where carnumber = '"+s1+"'";
